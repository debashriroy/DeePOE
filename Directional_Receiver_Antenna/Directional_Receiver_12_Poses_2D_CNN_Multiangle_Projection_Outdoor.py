...
filepath = '/Users/debashri/Desktop/DirectionFinding_Plots/Outdoor/double_direction_2D_CNN.wts.h5'
...
saved_file = '/Users/debashri/Desktop/DirectionFinding_Plots/Outdoor/double_direction_classifier.h5'
...
plt.legend()
plt.tight_layout()
fig.savefig('/Users/debashri/Desktop/DirectionFinding_Plots/Outdoor/double_direction_5ft_acc_outdoor.png')  # save the figure to file
plt.close(fig)
...
for i in range(0, xtest.shape[0]):
    ...
    conf[j, k] = conf[j, k] + 1
plot_confusion_matrix(conf, labels=classes, normalize=False, filedest='/Users/debashri/Desktop/DirectionFinding_Plots/Outdoor/double_direction_5ft_conf_mat_outdoor.png')
