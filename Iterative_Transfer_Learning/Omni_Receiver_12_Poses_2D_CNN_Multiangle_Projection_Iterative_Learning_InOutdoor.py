...
# IMPLEMENTING ITERATIVE TRANSFER LEARNING
...
sample_size = 128  # CHANGE AND EXPERIMENT -1024
no_of_samples = 128 # CHANGE AND EXPERIMENT - 5120
no_of_features= 8 # CHANGE AND EXPERIMENT
number_of_data_to_read = sample_size * no_of_samples
folder_path_indoor = '/Users/debashri/Desktop/DirectionFinding_Data/Indoor/DataJune16Indoor/'  # CHANGE AS PER YOUR COMPUTER FOLDER PATH
...
#############################################################################################################################
#INDOOR DATA
data_file_loc1 = folder_path_indoor + '5ft/0_5ft_06_16_2020_914MHz_indoor.dat' # TRANSMITTER DIRECTLY POINTING TO THE RECEIVER
data_file_loc2 =folder_path_indoor + '5ft/+30_5ft_06_16_2020_914MHz_indoor.dat' # TRANSMITTER ANTENNA IS 30 DEGREE LEFT TO THE RECEIVER
data_file_loc3 = folder_path_indoor + '5ft/+60_5ft_06_16_2020_914MHz_indoor.dat'# TRANSMITTER ANTENNA IS 60 DEGREE LEFT TO THE RECEIVER
data_file_loc4 = folder_path_indoor + '5ft/+90_5ft_06_16_2020_914MHz_indoor.dat' # TRANSMITTER ANTENNA IS 90 DEGREE LEFT TO THE RECEIVER

data_file_loc5 = folder_path_indoor + '5ft/+120_5ft_06_16_2020_914MHz_indoor.dat' # TRANSMITTER ANTENNA IS 120 DEGREE LEFT TO THE RECEIVER
data_file_loc6 =folder_path_indoor + '5ft/+150_5ft_06_16_2020_914MHz_indoor.dat'# TRANSMITTER ANTENNA IS 150 DEGREE LEFT TO THE RECEIVER
data_file_loc7 = folder_path_indoor + '5ft/180_5ft_06_16_2020_914MHz_indoor.dat'# TRANSMITTER ANTENNA IS DIRECTLY POINTED AWAY FROM THE RECEIVER
data_file_loc8 = folder_path_indoor + '5ft/-150_5ft_06_16_2020_914MHz_indoor.dat' # TRANSMITTER ANTENNA IS 30 DEGREE RIGHT TO THE RECEIVER

data_file_loc9 = folder_path_indoor + '5ft/-120_5ft_06_16_2020_914MHz_indoor.dat' # TRANSMITTER ANTENNA IS 60 DEGREE RIGHT TO THE RECEIVER
data_file_loc10 =folder_path_indoor + '5ft/-90_5ft_06_16_2020_914MHz_indoor.dat' # TRANSMITTER ANTENNA IS 90 DEGREE RIGHT TO THE RECEIVER
data_file_loc11 = folder_path_indoor + '5ft/-60_5ft_06_16_2020_914MHz_indoor.dat' # TRANSMITTER ANTENNA IS 120 DEGREE RIGHT TO THE RECEIVER
data_file_loc12 = folder_path_indoor + '5ft/-30_5ft_06_16_2020_914MHz_indoor.dat' # TRANSMITTER ANTENNA IS 150 DEGREE RIGHT TO THE RECEIVER
...
#############################################################################################################################
# INDOOR DATA
data_file_loc1 = folder_path_indoor + '10ft/0_10ft_06_16_2020_914MHz_indoor.dat' # TRANSMITTER DIRECTLY POINTING TO THE RECEIVER
data_file_loc2 =folder_path_indoor + '10ft/+30_10ft_06_16_2020_914MHz_indoor.dat' # TRANSMITTER ANTENNA IS 30 DEGREE LEFT TO THE RECEIVER
data_file_loc3 = folder_path_indoor + '10ft/+60_10ft_06_16_2020_914MHz_indoor.dat'# TRANSMITTER ANTENNA IS 60 DEGREE LEFT TO THE RECEIVER
data_file_loc4 = folder_path_indoor + '10ft/+90_10ft_06_16_2020_914MHz_indoor.dat' # TRANSMITTER ANTENNA IS 90 DEGREE LEFT TO THE RECEIVER

data_file_loc5 = folder_path_indoor + '10ft/+120_10ft_06_16_2020_914MHz_indoor.dat' # TRANSMITTER ANTENNA IS 120 DEGREE LEFT TO THE RECEIVER
data_file_loc6 =folder_path_indoor + '10ft/+150_10ft_06_16_2020_914MHz_indoor.dat'# TRANSMITTER ANTENNA IS 150 DEGREE LEFT TO THE RECEIVER
data_file_loc7 = folder_path_indoor + '10ft/180_10ft_06_16_2020_914MHz_indoor.dat'# TRANSMITTER ANTENNA IS DIRECTLY POINTED AWAY FROM THE RECEIVER
data_file_loc8 = folder_path_indoor + '10ft/-150_10ft_06_16_2020_914MHz_indoor.dat' # TRANSMITTER ANTENNA IS 30 DEGREE RIGHT TO THE RECEIVER

data_file_loc9 = folder_path_indoor + '10ft/-120_10ft_06_16_2020_914MHz_indoor.dat' # TRANSMITTER ANTENNA IS 60 DEGREE RIGHT TO THE RECEIVER
data_file_loc10 =folder_path_indoor + '10ft/-90_10ft_06_16_2020_914MHz_indoor.dat' # TRANSMITTER ANTENNA IS 90 DEGREE RIGHT TO THE RECEIVER
data_file_loc11 = folder_path_indoor + '10ft/-60_10ft_06_16_2020_914MHz_indoor.dat' # TRANSMITTER ANTENNA IS 120 DEGREE RIGHT TO THE RECEIVER
data_file_loc12 = folder_path_indoor + '10ft/-30_10ft_06_16_2020_914MHz_indoor.dat' # TRANSMITTER ANTENNA IS 150 DEGREE RIGHT TO THE RECEIVER
...
#############################################################################################################################
# INDOOR DATA
data_file_loc1 = folder_path_indoor + '15ft/0_15ft_06_16_2020_914MHz_indoor.dat' # TRANSMITTER DIRECTLY POINTING TO THE RECEIVER
data_file_loc2 =folder_path_indoor + '15ft/+30_15ft_06_16_2020_914MHz_indoor.dat' # TRANSMITTER ANTENNA IS 30 DEGREE LEFT TO THE RECEIVER
data_file_loc3 = folder_path_indoor + '15ft/+60_15ft_06_16_2020_914MHz_indoor.dat'# TRANSMITTER ANTENNA IS 60 DEGREE LEFT TO THE RECEIVER
data_file_loc4 = folder_path_indoor + '15ft/+90_15ft_06_16_2020_914MHz_indoor.dat' # TRANSMITTER ANTENNA IS 90 DEGREE LEFT TO THE RECEIVER

data_file_loc5 = folder_path_indoor + '15ft/+120_15ft_06_16_2020_914MHz_indoor.dat' # TRANSMITTER ANTENNA IS 120 DEGREE LEFT TO THE RECEIVER
data_file_loc6 =folder_path_indoor + '15ft/+150_15ft_06_16_2020_914MHz_indoor.dat'# TRANSMITTER ANTENNA IS 150 DEGREE LEFT TO THE RECEIVER
data_file_loc7 = folder_path_indoor + '15ft/180_15ft_06_16_2020_914MHz_indoor.dat'# TRANSMITTER ANTENNA IS DIRECTLY POINTED AWAY FROM THE RECEIVER
data_file_loc8 = folder_path_indoor + '15ft/-150_15ft_06_16_2020_914MHz_indoor.dat' # TRANSMITTER ANTENNA IS 30 DEGREE RIGHT TO THE RECEIVER

data_file_loc9 = folder_path_indoor + '15ft/-120_15ft_06_16_2020_914MHz_indoor.dat' # TRANSMITTER ANTENNA IS 60 DEGREE RIGHT TO THE RECEIVER
data_file_loc10 =folder_path_indoor + '15ft/-90_15ft_06_16_2020_914MHz_indoor.dat' # TRANSMITTER ANTENNA IS 90 DEGREE RIGHT TO THE RECEIVER
data_file_loc11 = folder_path_indoor + '15ft/-60_15ft_06_16_2020_914MHz_indoor.dat' # TRANSMITTER ANTENNA IS 120 DEGREE RIGHT TO THE RECEIVER
data_file_loc12 = folder_path_indoor + '15ft/-30_15ft_06_16_2020_914MHz_indoor.dat' # TRANSMITTER ANTENNA IS 150 DEGREE RIGHT TO THE RECEIVER
...
num_classes_ranging = 3  # TOTAL NUMBER OF RANGES



# Convert labels to categorical one-hot encoding
ytrain_ranging_one_hot = to_categorical(ytrain_ranging, num_classes=num_classes_ranging)  # DEFINE THE NUMBER OF TOTAL CLASSES IN LABEL
ytest_ranging_one_hot = to_categorical(ytest_ranging, num_classes=num_classes_ranging)
...
# print ("AFTER RESHAPE")
ytrain_ranging_one_hot = np.reshape(ytrain_ranging_one_hot, (ytrain_ranging_one_hot.shape[0], num_classes_ranging))  # Used in training
ytest_ranging_one_hot = np.reshape(ytest_ranging_one_hot, (ytest_ranging_one_hot.shape[0], num_classes_ranging))  # Used in training
...
# plt.legend()
# plt.tight_layout()
# fig.savefig('/Users/debashri/Desktop/DirectionFinding_Plots/InOutdoor/ranging_acc_IL.png')  # save the figure to file
# plt.close(fig)
...
#     conf[j, k] = conf[j, k] + 1
# plot_confusion_matrix(conf, labels=classes, normalize=False, filedest='/Users/debashri/Desktop/DirectionFinding_Plots/InOutdoor/ranging_conf_mat_IL.png')
...
#############################################################################################################################
num_classes_pose = 12  # TOTAL NUMBER OF RANGES
...
# Convert labels to categorical one-hot encoding
ytrain_pose_one_hot = to_categorical(ytrain_pose, num_classes=num_classes_pose)  # DEFINE THE NUMBER OF TOTAL CLASSES IN LABEL
ytest_pose_one_hot = to_categorical(ytest_pose, num_classes=num_classes_pose)
...
# print ("AFTER RESHAPE")
ytrain_pose_one_hot = np.reshape(ytrain_pose_one_hot, (ytrain_pose_one_hot.shape[0], num_classes_pose))  # Used in training
ytest_pose_one_hot = np.reshape(ytest_pose_one_hot, (ytest_pose_one_hot.shape[0], num_classes_pose))  # Used in training
...
nb_epoch = 3  # Number of Epoch (Give a higher number to get better accuracy)

classes_ranges = ["5ft", "10ft", "15ft"] # CHANGE LABEL

classes_pose = ["0", "+30", "+60", "+90", "+120", "+150", "180", "-150", "-120", "-90", "-60", "-30"] # CHANGE LABEL
...
# OUTPUT LAYER
model_ranging.add(Dense(num_classes_ranging, activation='softmax'))
...
#################### IMPLEMENTING THE ITERATIVE LEARNING #######################
history = model_ranging.train_on_batch(xtrain_ranging[0:batch_size,:], ytrain_ranging_one_hot[0:batch_size, :])



# SAVING THE MODEL FOR TRANSFER LEARNING
saved_file_ranging = '/Users/debashri/Desktop/DirectionFinding_Plots/InOutdoor/saved_classifier_ranging_IL.h5'
model_ranging.save(saved_file_ranging) # SAVING THE MODEL FOR TRANSFER LEARNING
...
############################################################
#                                                          #
########    Loading a 2D Convolutional Neural Network   #####
#							                               #
############################################################

#IMPLEMENTING THE TRANSFER LEARNING
#loading the previously saved model
source_model = load_model(saved_file_ranging, custom_objects={
        "f1_m": f1_m,
...
# ADDING OUTPUT LAYER
model_pose.add(Dense(num_classes_pose, activation='softmax'))
...
############ IMPLEMENTING TRAINING ON FIRST BATCH #################
history = model_pose.train_on_batch(xtrain_pose[0:batch_size,:], ytrain_pose_one_hot[0:batch_size, :])

# SAVING THE MODEL FOR TRANSFER LEARNING
saved_file_pose = '/Users/debashri/Desktop/DirectionFinding_Plots/InOutdoor/saved_classifier_pose_IL.h5'
model_pose.save(saved_file_pose) # SAVING THE MODEL FOR TRANSFER LEARNING
...
print("***** STARTING THE ITERATIVE TRANSFER LEARNING ON BOTH RANGING AND POSE ESTIMATION DATA******")
print("The xtrain shape of ranging data: ", xtrain_ranging.shape)
print("The xtrain shape of pose data: ", xtrain_pose.shape)
...
for e in tqdm(range(nb_epoch)):
    for i in tqdm(range(0, xtrain_ranging.shape[0]//batch_size)):

        # IMPLEMENTING ON RANGING DATA
        # IMPLEMENTING THE TRANSFER LEARNING
        # loading the previously saved model
        source_model = load_model(saved_file_pose, custom_objects={
            "f1_m": f1_m,
            "precision_m": precision_m,
            "recall_m": recall_m
        })
        ...
        model_ranging = Sequential()
        for layer in source_model.layers[:-3]:  # go through until last layer
            model_ranging.add(layer)

        ####################  -  THIS NOT WORKING #############
        # model_ranging = load_model(saved_file, custom_objects={
        #         "f1_m": f1_m,
        #         "precision_m": precision_m,
        #         "recall_m": recall_m
        #     })
        ...
        # POPING THE LAST THREE DENSE LAYERs (2 Hidden  + 1 Output)
        # modelmodel_ranging.layers.pop()
        # model_ranging.layers.pop()
        # model_ranging.layers.pop()
        ####################  -  THIS NOT WORKING #############
        ...
        ############ IMPLEMENTING TRAINING ON ith BATCH #################
        history = model_ranging.train_on_batch(xtrain_ranging[(i*batch_size):((i+1)*batch_size), :], ytrain_ranging_one_hot[(i*batch_size):((i+1)*batch_size), :])

        print("The Results for Ranging on", i, "th of total", (xtrain_ranging.shape[0]//batch_size),"  Batch: ")
        # Evaluate the model
        loss, accuracy, f1_score, precision, recall = model_ranging.evaluate(xtest_ranging, ytest_ranging_one_hot,
                                                                             batch_size=batch_size)  # CHANGE
        print("Test Loss: %s: %.2f%%" % (model_ranging.metrics_names[0], loss * 100))  # CHANGE
        print("Test Accuracy: %s: %.2f%%" % (model_ranging.metrics_names[1], accuracy * 100))  # CHANGE

        # SAVING THE MODEL FOR TRANSFER LEARNING
        saved_file_ranging = '/Users/debashri/Desktop/DirectionFinding_Plots/InOutdoor/saved_classifier_ranging_IL.h5'
        model_ranging.save(saved_file_ranging)  # SAVING THE MODEL FOR TRANSFER LEARNING

        # IMPLEMENTING THE TRANSFER LEARNING on POSE DATA
        # loading the previously saved model
        source_model = load_model(saved_file_ranging, custom_objects={
            "f1_m": f1_m,
            "precision_m": precision_m,
        ...
        ############ IMPLEMENTING TRAINING ON iTH BATCH #################
        history = model_pose.train_on_batch(xtrain_pose[(i*batch_size):((i+1)*batch_size), :], ytrain_pose_one_hot[(i*batch_size):((i+1)*batch_size), :])

        print("The Results for Pose Estimation on", i, "th of total", (xtrain_ranging.shape[0]//batch_size),"  Batch: ")
        # Evaluate the model
        loss, accuracy, f1_score, precision, recall = model_pose.evaluate(xtest_pose, ytest_pose_one_hot,
                                                                          batch_size=batch_size)  # CHANGE
        print("Test Loss: %s: %.2f%%" % (model_pose.metrics_names[0], loss * 100))  # CHANGE
        print("Test Accuracy: %s: %.2f%%" % (model_pose.metrics_names[1], accuracy * 100))  # CHANGE

        # SAVING THE MODEL FOR TRANSFER LEARNING
        saved_file_pose = '/Users/debashri/Desktop/DirectionFinding_Plots/InOutdoor/saved_classifier_pose_IL.h5'
        model_pose.save(saved_file_pose)  # SAVING THE MODEL FOR TRANSFER LEARNING

    print("***** COMPLETION OF", e, "th Epoch *********")
    print("The Results for Ranging Test data: ")
    # Evaluate the model
    loss, accuracy, f1_score, precision, recall = model_ranging.evaluate(xtest_ranging, ytest_ranging_one_hot,
                                                                         batch_size=batch_size)  # CHANGE
    acc_ranging.append(accuracy)
    print("\nTest Loss: %s: %.2f%%" % (model_ranging.metrics_names[0], loss * 100))  # CHANGE
    print("\nTest Accuracy: %s: %.2f%%" % (model_ranging.metrics_names[1], accuracy * 100))  # CHANGE


    print("The Results for Pose Estimation Test data: ")
    # Evaluate the model
    loss, accuracy, f1_score, precision, recall = model_pose.evaluate(xtest_pose, ytest_pose_one_hot,
                                                                      batch_size=batch_size)  # CHANGE
    acc_pose.append(accuracy)
    print("\nTest Loss: %s: %.2f%%" % (model_pose.metrics_names[0], loss * 100))  # CHANGE
    print("\nTest Accuracy: %s: %.2f%%" % (model_pose.metrics_names[1], accuracy * 100))  # CHANGE
...
print("***** UPON COMPLETION OF THE ITERATIVE LEARNING*********")
print("The Results for Ranging Test data: ")
# Evaluate the model
loss, accuracy, f1_score, precision, recall = model_ranging.evaluate(xtest_ranging, ytest_ranging_one_hot, batch_size=batch_size) # CHANGE
print("\nTest Loss: %s: %.2f%%" % (model_ranging.metrics_names[0], loss * 100)) # CHANGE
...
print("The Accuracy list of ranging results: ", acc_ranging)
print("The Accuracy list of pose estimation results: ", acc_pose)
