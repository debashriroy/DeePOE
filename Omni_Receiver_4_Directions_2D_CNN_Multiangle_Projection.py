...
data_file_loc1 = '/Users/debashri/Desktop/DirectionFinding_Data/W_E_29_05_2020_914MHz_source.dat' # TRANSMITTER IS WEST TO THE RECEIVER, TRANSMITTER ANTENNA TO EAST
data_file_loc2 ='/Users/debashri/Desktop/DirectionFinding_Data/W_W_29_05_2020_914MHz_source.dat' # TRANSMITTER IS WEST TO THE RECEIVER, TRANSMITTER ANTENNA TO WEST
data_file_loc3 = '/Users/debashri/Desktop/DirectionFinding_Data/W_N_29_05_2020_914MHz_source.dat'# TRANSMITTER IS WEST TO THE RECEIVER, TRANSMITTER ANTENNA TO NORTH
data_file_loc4 = '/Users/debashri/Desktop/DirectionFinding_Data/W_S_29_05_2020_914MHz_source.dat' # TRANSMITTER IS WEST TO THE RECEIVER, TRANSMITTER ANTENNA TO SOUTH
...
model.summary()
filepath = '/Users/debashri/Desktop/DirectionFinding_Plots/direction_data_4_direction_2D_CNN_Mapping.wts.h5'
...
plt.tight_layout()
fig.savefig('/Users/debashri/Desktop/DirectionFinding_Plots/direction_4_acc_2D_CNN_Mapping.png')  # save the figure to file
plt.close(fig)
...
def plot_confusion_matrix(cm, title='Confusion Matrix', cmap=plt.cm.YlGnBu, labels=[], normalize=False):
    ...
    plt.tight_layout()
    fig.savefig('/Users/debashri/Desktop/DirectionFinding_Plots/direction_4_conf_mat_2D_CNN_Mapping.png')  # save the figure to file
    plt.close(fig)
