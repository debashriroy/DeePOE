...
model.summary()
filepath = '/Users/debashri/Desktop/DirectionFinding_Plots/direction_data_4_direction_2D_CNN.wts.h5'
...
plt.tight_layout()
fig.savefig('/Users/debashri/Desktop/DirectionFinding_Plots/direction_4_acc_2D_CNN.png')  # save the figure to file
plt.close(fig)
...
def plot_confusion_matrix(cm, title='Confusion Matrix', cmap=plt.cm.YlGnBu, labels=[], normalize=False):
    ...
    plt.tight_layout()
    fig.savefig('/Users/debashri/Desktop/DirectionFinding_Plots/direction_4_conf_mat_2D_CNN.png')  # save the figure to file
    plt.close(fig)
