...
no_of_samples = 1000 # CHANGE AND EXPERIMENT - 4000
...
filepath = '/Users/debashri/Desktop/DirectionFinding_Plots/InOutdoor/direction_data_ranging_2D_CNN_Mapping.wts.h5'
...
saved_file = '/Users/debashri/Desktop/DirectionFinding_Plots/InOutdoor/2D_CNN_ranging_classifier.h5'
...
plt.legend()
plt.tight_layout()
fig.savefig('/Users/debashri/Desktop/DirectionFinding_Plots/InOutdoor/direction_ranging_acc_2D_CNN_Mapping.png')  # save the figure to file
plt.close(fig)
...
for i in range(0, xtest_ranging.shape[0]):
    ...
    conf[j, k] = conf[j, k] + 1
plot_confusion_matrix(conf, labels=classes, normalize=False, filedest='/Users/debashri/Desktop/DirectionFinding_Plots/InOutdoor/direction_ranging_conf_mat_2D_CNN_Mapping.png')
...
model_pose.summary()
filepath = '/Users/debashri/Desktop/DirectionFinding_Plots/InOutdoor/direction_data_12_poses_2D_CNN_Mapping.wts.h5'
print("The dropout rate was: ")
print(dr)
...
plt.legend()
plt.tight_layout()
fig.savefig('/Users/debashri/Desktop/DirectionFinding_Plots/InOutdoor/direction_12_poses_acc_2D_CNN_Mapping.png')  # save the figure to file
plt.close(fig)
...
for i in range(0, xtest_pose.shape[0]):
    ...
    k = int(np.argmax(test_Y_hat[i, :]))
    conf[j, k] = conf[j, k] + 1
plot_confusion_matrix(conf, labels=classes, normalize=False, filedest= '/Users/debashri/Desktop/DirectionFinding_Plots/InOutdoor/direction_12_poses_conf_mat_2D_CNN_Mapping.png')
