...
model_pose.summary()
filepath = '/Users/debashri/Desktop/DirectionFinding_Plots/Indoor/direction_data_12_poses_2D_CNN_Mapping.wts.h5'
print("The dropout rate was: ")
print(dr)
...
plt.legend()
plt.tight_layout()
fig.savefig('/Users/debashri/Desktop/DirectionFinding_Plots/Indoor/direction_12_poses_acc_2D_CNN_Mapping.png')  # save the figure to file
plt.close(fig)
...
for i in range(0, xtest_pose.shape[0]):
    ...
    k = int(np.argmax(test_Y_hat[i, :]))
    conf[j, k] = conf[j, k] + 1
plot_confusion_matrix(conf, labels=classes, normalize=False, filedest= '/Users/debashri/Desktop/DirectionFinding_Plots/Indoor/direction_12_poses_conf_mat_2D_CNN_Mapping.png')
